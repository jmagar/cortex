...
main() {
  ...
  export_if_set CORTEX_RECEIVER_HOST CLAUDE_PLUGIN_OPTION_SYSLOG_HOST
  export_if_set CORTEX_RECEIVER_PORT CLAUDE_PLUGIN_OPTION_SYSLOG_PORT
  export_if_set CORTEX_RECEIVER_HOST_PORT CLAUDE_PLUGIN_OPTION_SYSLOG_HOST_PORT

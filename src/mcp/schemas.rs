    ...
    vec![json!({
        ...
        "inputSchema": {
            ...
            "properties": {
                ...
                "source_ip": {
                    "type": "string",
                    "description": "For action=search, tail, correlate, or ai_correlate: exact source identifier. Syslog uses IP:port; Docker ingest uses docker://host/container/stream."
                },
                "severity": {
                    "type": "string",

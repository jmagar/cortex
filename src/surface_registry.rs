...
pub const CLI_SURFACES: &[CliSurface] = &[
    ...
    cli("ingest-rate", SurfaceDomain::Stats, true),
    cli("clock-skew", SurfaceDomain::State, true),
    cli("anomalies", SurfaceDomain::Analysis, true),
    cli("compare", SurfaceDomain::Analysis, true),
    cli("apps", SurfaceDomain::Logs, true),
    cli("host-state", SurfaceDomain::State, true),
    cli("fleet-state", SurfaceDomain::State, true),
    ...
    operational("shell", SurfaceDomain::Ingest, false),
    operational("agent-command", SurfaceDomain::Ingest, false),

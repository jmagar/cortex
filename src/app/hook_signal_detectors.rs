...
/// within one incident window that counts as "too often". Chosen well above
/// a normal single-turn PreToolUse/PostToolUse pairing (1-2 invocations per
/// tool call) so routine multi-tool-call turns don't false-positive.
pub const HOOK_TOO_FREQUENT_THRESHOLD: usize = 10;

...
use super::models::{
    ...
    CorrelateStateRequest, CorrelateStateResponse, CorrelateStateHostEntry, CorrelateStateWindow,
    FleetStateRequest, FleetStateResponse, FleetStateHostRow, FleetStateSummary,
...
impl SyslogService {
    ...
    pub async fn fleet_state(
        ...
        let total = rows.len();
        let mut summary = FleetStateSummary { total, ..Default::default() };
        for row in &rows {
        ...
        Ok(FleetStateResponse { hosts: rows, summary })
    }

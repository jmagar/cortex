...
pub use models::{
    ...
    AiIncidentParams, AiIncidentResult, AiProjectContext, AiProjectContextParams,
    AiProjectInventoryEntry, AiRelatedLogsForAnchor, AiRelatedLogsParams, AiRelatedWindow,
    AiSessionEntry, AiToolInventoryEntry, AiUsageBlock, AiUsageBlocksParams, AiUsageBlocksResult,
    DbStats, DockerCheckpoint, ErrorSummaryEntry, HostEntry, ListAiProjectsParams,
    ListAiProjectsResult, ListAiSessionsParams, ListAiToolsParams, ListAiToolsResult, LogBatchEntry,
    LogEntry, SearchAiSessionsParams, SearchAiSessionsResult, SearchParams, SearchedAiSessionEntry,
};
...
pub use queries::{
    ...
    search_ai_sessions, search_logs, severity_to_num, tail_logs, validate_fts_query,
    SEVERITY_LEVELS,
};
